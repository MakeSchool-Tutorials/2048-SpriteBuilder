---
title: Build your own 2048 with SpriteBuilder & Cocos2D - Pt 1
slug: part-1
gamernews_id: 384
---
...
![Change game orientation](./SpriteBuilder_Portrait.png)
...
![Open the code connections tab](./Grid_CodeConnect.png)
...
![Adding score labels](./ScoreLabels.png)
...
![Connecting the score to the code](./score_code_connection.png)

![Connecting the highscore to the code](./highscore_code_connection.png)
...
![Add a new tile](./SpriteBuilder_Tile_new.png)

The type of the new CCB file should be *Node*.

![Setting the tile size](./SpriteBuilder_Tile_size.png)
...
![Link tile to custom class](./SpriteBuilder_Tile_class_connection.png)
...
![Adding a color node](./SpriteBuilder_Tile_color.png)
...
![Setting color node to fill root](./SpriteBuilder_Tile_color_size.png)
...
![Changing color with code](./SpriteBuilder_Tile_color_code_connection.png)
...
![Dropping label to stage](./SpriteBuilder_Tile_label.png)

Once you have added the label you need to change a couple of settings:

![Changing label configuration](./SpriteBuilder_Tile_label_config.png)
...
![Connecting the code to the label](./SpriteBuilder_Tile_label_code_connection.png)
...
![New grid class](./Xcode_Grid_new.png)
...
![New tile class](./Xcode_Tile_new.png)
...
![Game in simulator](./Simulator_first.png)
...
![Grid in the simulator](./Simulator_grid.png)
...
![Two spawned tiles in simulator](./Simulator_spawning.png)
