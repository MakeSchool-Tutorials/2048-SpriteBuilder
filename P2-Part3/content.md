...
Once we know that the score of the Grid changed we can perform a certain action. In this case we set the the text of the _scoreLabel  to the new score. Now we are almost done with updating the displayed score!
...
Stay tuned for future tutorials &amp; apply to our Summer Academy!

benji@makegameswith.us

Reminder: you can find the entire project on GitHub.
